...
def datafr():
    df= pd.read_csv("C:/Users/ELCOT/Desktop/Airbnb/Airbnb.csv")
    return df

df= datafr()

with st.sidebar:
    select= option_menu("Menu", ["Home", "Data Exploration", "About"])

if select == "Home":

    image1= Image.open("C:/Users/ELCOT/Desktop/Airbnb/download.jpg")
    st.image(image1)
...
if select == "Data Exploration":
    ...
    with tab2:
        ...
        def datafr():
            df_a= pd.read_csv("C:/Users/ELCOT/Desktop/Airbnb/Airbnb.csv")
            return df_a
